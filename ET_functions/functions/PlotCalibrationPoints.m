...
%     end
         ...
         %show calibrationplot on upper right quarter of main screen
%          screensize=get(0,'MonitorPositions');
%          screensize=screensize(1,:);
%          figloc.x =  screensize(1) + screensize(3)/2;
% 		 figloc.y =  screensize(2);
% 		 figloc.width =  screensize(3)/2;
% 		 figloc.height =  screensize(4)/2;

         figloc.x =  Calib.mondims1.x + Calib.mondims1.width/2;
		 figloc.y =  - Calib.mondims1.height/2;
		 figloc.width =  Calib.mondims1.width/2;
		 figloc.height =  Calib.mondims1.height/2;
