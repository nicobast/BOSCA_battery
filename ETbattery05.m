...
disp('EYE-TRACKING TESTBATTERY 0.6')

%% DEVMODE - changes eye-tracking functions to dummy
devmode = 0; %set 1 to deactivate eye-tracking + data rec, DEFAULT = 0 !!!
...
%%%%            INIT PSYCHTOOLBOX 
        ...
        if devmode==1
           ...
           %[window, windowRect] = PsychImaging('OpenWindow', screenNumber, bgd, [screenres.width/2 1 screenres.width screenres.height/2]);
 ...
 rewardtrials=10; %20 in final rewardblock
 vissearchtrials=16; %16 trials per block in final visualsearch
 voddballtimes=4; %4 target-distractor presentations in final voddball
