...
%PREPARE
%open grey background --> Ctrl + H = Fullscreen
%open basic eye tracking sample on first screen
%set task bar to vanish
...
fprintf(1,'<strong>EYE-TRACKING TESTBATTERY 0.4</strong>\n')
